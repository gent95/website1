        ...
        var sliderFun = {
            controlInit: function () {
                ...
                if (settings.arrowControl) {
                    var html = "";
                    html += '<span class="slider-control prev"><img src="'+frontPath+'/static/frontImg/homepage/left.png"/></span>';
                    html += '<span class="slider-control next"><img src="'+frontPath+'/static/frontImg/homepage/right.png"/></span>'
                    $slider.append(html);
                }
